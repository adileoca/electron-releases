...
const StatusBadge: React.FC<{
  ...
  <div
    ...
    className={clsx(
      ...
      color === "amber" ? " from-amber-600 to-amber-500 p-px" : "",
      color === "red" ? "from-red-500 to-red-400" : "",
      color === undefined ? "from-neutral-500 to-neutral-400 " : "",
      "rounded-md bg-gradient-to-t from-85% p-px shadow shadow-black/20"
    )}
  >
    <div
      className={clsx(
        ...
        " items-center gap-x-1.5 rounded-[5px] px-2.5 py-0.5 text-sm font-medium text-white/90"
      )}
    >
