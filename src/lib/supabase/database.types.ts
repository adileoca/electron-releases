  ...
  public: {
    Tables: {
      ...
      customer_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "customer_profiles_storefront_id_fkey"
      ...
      product_image_storefronts: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_image_storefronts_product_image_id_fkey"
          ...
          {
            foreignKeyName: "product_image_storefronts_storefront_id_fkey"
            columns: ["storefront_id"]
            isOneToOne: false
            referencedRelation: "storefronts"
            referencedColumns: ["id"]
      ...
      review_attachments: {
        ...
        Relationships: [
          {
            foreignKeyName: "review_attachments_media_id_fkey"
            columns: ["media_id"]
            isOneToOne: false
            referencedRelation: "media"
            referencedColumns: ["id"]
      ...
      session_consent: {
        ...
        Relationships: [
          {
            foreignKeyName: "session_consent_id_fkey"
            columns: ["id"]
            isOneToOne: true
            referencedRelation: "sessions"
            referencedColumns: ["id"]
      ...
      session_fbclids: {
        ...
        Relationships: [
          {
            foreignKeyName: "session_fbclids_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "sessions"
            referencedColumns: ["id"]
      ...
      session_gclids: {
        ...
        Relationships: [
          {
            foreignKeyName: "session_gclids_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "sessions"
            referencedColumns: ["id"]
      ...
      sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "sessions_storefront_id_fkey"
            columns: ["storefront_id"]
            isOneToOne: false
            referencedRelation: "storefronts"
            referencedColumns: ["id"]
      ...
      shipment_batch_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "shipment_batch_orders_batch_id_fkey"
            columns: ["batch_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "shipment_batch_orders_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "orders"
            referencedColumns: ["id"]
      ...
      storefronts: {
        Row: {
          ...
          gads_offline_conversion_id: string
          id: string
          locale: string
