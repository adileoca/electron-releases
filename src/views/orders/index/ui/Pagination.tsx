...
const Pagination = () => {
  ...
  return (
    ...
    >
      <div className="flex h-12 items-center justify-between overflow-hidden rounded-b-[7px] border-t border-neutral-700 bg-neutral-900/90 px-3 py-2 backdrop-blur-xl">
        <div className="flex items-center space-x-5">
          ...
          <button className=" flex items-center space-x-1.5 rounded-md border border-neutral-700 p-1 pl-3 pr-1.5 text-neutral-200 transition hover:border-neutral-500 hover:text-neutral-200">
            <span className="text-sm font-semibold">câte 100 rânduri</span>
            <ChevronUpIcon className="size-5 text-neutral-200" />
          </button>
